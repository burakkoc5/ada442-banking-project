...
# Eğitilmiş modelinizi model adlı bir değişkene atayın
model = model  # Eğitilmiş modelinizi buraya ekleyin

# Modelinizi joblib ile kaydedin
joblib.dump(model, 'xgboost_banking_model.joblib')
